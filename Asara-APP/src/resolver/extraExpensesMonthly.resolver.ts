...
@Injectable()
export class ExtraExpensesMonthlyResolver implements Resolve<ExtraExpenses[]> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): ExtraExpenses[] | Observable<ExtraExpenses[]> | Promise<ExtraExpenses[]> {
        return this.barrenService.getExtraExpensesByMonth(new Date().toLocaleDateString());
    }
